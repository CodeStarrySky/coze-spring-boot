...
public class FlightBookingService {
	...
	private BookingTools.BookingDetails toBookingDetails(Booking booking) {
		return new BookingTools.BookingDetails(booking.getBookingNumber(), booking.getCustomer().getName(), booking.getDate().toString(),
				booking.getBookingStatus().toString(), booking.getFrom(), booking.getTo(), booking.getBookingClass().toString());
	}
